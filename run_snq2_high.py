...
init_update_freq = 30000
schedule = 'dynamic'
log_file = 'data/' + env.get_name() + '/snq2/log_' + prior_init + '_' + schedule + '_' + str(init_update_freq) + '.csv'
train(game,
      evaluator,
      log_file,
      policies_file,
      ...
      total_n_episodes=400001, fixed_beta_episode=350000,
